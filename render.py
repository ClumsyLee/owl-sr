...
def render_about(predictor):
  ...
  <div class="col-lg-8 col-md-10 col-sm-12 mx-auto">
    ...
    <h3>Did You Consider Draws/Bans/Transfers/Underages?</h3>
    <p>Yes.</p>

    <h3>Did You Consider Tie-breakers/BO5 for the Title Matches?</h3>
    <p>Yes.</p>

    <h3>But How Did You Determine the Rosters?</h3>
    ...
    <h3>What Parameters Did You Use?</h3>
    <ul>
    ...
    <h3>May I See Your Source Code?</h3>
